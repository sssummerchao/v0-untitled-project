// Add a constant for the Teachable Machine model URL to ensure consistency across components
export const TEACHABLE_MACHINE_URL = "https://teachablemachine.withgoogle.com/models/zQHyr94Fi/"

// Export the fabric mapping for consistent use across components
export const FABRIC_CLASS_MAPPING: Record<string, string> = {
...
export const FEATURED_FABRICS = ["fabric1", "fabric10", "fabric17"]

// Get all fabric keys for random selection
export const ALL_FABRIC_KEYS = Object.keys(FABRIC_TEXTURES)

// Existing fabric constants
...
// Add storage keys for each pattern
...
// Default colors for each pattern if no fabric is selected
export const DEFAULT_COLORS = {
  NORTH_STAR: {
    outerSquares: "#F9A826",
    triangles: "#C74B16",
    diagonalTriangles: "#A7C5EB",
    centerSquare: "#C7F9CC",
  },
  CROSSROADS: {
    blue: "#6A8EAE",
  ...
  LOG_CABIN: {
    center: "#D64933",
    strips: ["#F9E784", "#6A8EAE", "#F9E784", "#6A8EAE", "#F9E784", "#6A8EAE", "#F9E784", "#6A8EAE"],
  },
}
