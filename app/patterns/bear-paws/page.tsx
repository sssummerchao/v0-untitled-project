...
export default function BearPawsPage() {
  return (
    <main
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-2 flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div>
                  <h1 className="text-4xl font-bold text-gray-900 mb-6">Bear Paw</h1>
                  ...
                  <p className="text-lg text-gray-700 mb-8">
                    Quilts featuring a bear paw told freedom-seekers that they should avoid roads and travel along
                    animal trails to avoid slave catchers.
                  </p>
